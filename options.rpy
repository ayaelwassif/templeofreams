...
define config.name = _("Temple of Dreams")
...
define builditch_project = "ayael/Temple_of_Dreams"
## A short name for the game used for executables and directories in the built
## distribution. This must be ASCII-only, and must not contain spaces, colons,
## or semicolons.

define build.name = "TempleofDreams"
...
define config.save_directory = "TempleofDreams-1534257537"
